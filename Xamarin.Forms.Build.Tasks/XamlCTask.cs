						...
						foreach (var resource in module.Resources.OfType<EmbeddedResource>()) {
							...
							if (!TryCoreCompile(initComp, initCompRuntime, rootnode, xamlFilePath, out e)) {
								...
								if (e is BuildException be) 
									LoggingHelper.LogError("XamlC", be.Code.Code, be.HelpLink, xamlFilePath, be.XmlInfo?.LineNumber ?? 0, be.XmlInfo?.LinePosition ?? 0, 0, 0, ErrorMessages.ResourceManager.GetString(be.Code.ErrorMessage), be.MessageArgs);
